...
export const zhCN = {
  ...
  shopPage: {
    title: '店铺授权',
    description: '绑定 Amazon、Shopee、Lazada、TikTok Shop。授权完成后可立即拉取首笔订单。',
    guideTitle: '授权引导',
    guideSteps: '1. 完成邮箱验证。2. 选择平台和站点。3. 跳转授权并回到本页。4. 手动同步订单，确认首笔订单。',
    unverified: '邮箱尚未验证，验证后才能绑定店铺。',
    authorize: '授权店铺',
    platform: '平台',
    site: '站点',
    shopName: '店铺',
    platformShopId: '平台店铺 ID',
    health: '健康度',
    lastSync: '最近同步',
    lastError: '最近错误',
    status: '状态',
    ...
    unbind: '解绑',
    unbindTitle: '解绑店铺',
    unbindHint: '解绑后停止同步。历史数据默认保留 30 天。',
    password: '当前密码',
    module: '同步模块',
    moduleOrder: '订单',
    moduleProduct: '商品',
    ...
    healthYellow: '注意',
    healthRed: '异常',
    empty: '还没有店铺。完成授权后，这里会显示健康度和首笔订单。',
    firstOrder: '首笔订单',
    pulled: '拉取条数',
    retainUntil: '数据保留至',
    active: '已授权',
